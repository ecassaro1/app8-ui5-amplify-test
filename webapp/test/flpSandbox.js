			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"HelloUI5-display": {
								"semanticObject": "HelloUI5",
								"action": "display",
								"description": "Hello UI5",
								"title": "Hello UI5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=app8.app8",
									"url": sap.ui.require.toUrl("app8/app8")
								}
							}
						}
					}
